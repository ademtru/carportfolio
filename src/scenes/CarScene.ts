...
/**
 * Populates the provided scene with a simple car gym: two angled walls,
 * holds distributed on the walls, crash mats, and lighting.
 */
export function CarScene(scene: THREE.Scene, config?: { walls?: number }) {
  ...
  return { walls, holdsGroup, mats, ambientLight, directionalLight } as CarSceneObjects;
}
